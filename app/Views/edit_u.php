...
<main id="content">
  ...
  <?= form_open('registered_users/update') ?>
  ...
  <div class="row g-4 m-auto border p-3 bg-light" style="max-width: 700px">
    ...
    <div class="col-12 col-md-4">
      ...
      <input type="text" class="form-control" id="fname" name="fname" value="<?= $user['fname'] ?>" placeholder="Example input placeholder">
    </div>
    <div class="col-12 col-md-4">
      <label for="mname" class="form-label">Middle Name</label>
      <input type="text" class="form-control" id="mname" name="mname" value="<?= $user['mname'] ?>" placeholder="Example input placeholder">
    </div>
    <div class="col-12 col-md-4">
      <label for="lname" class="form-label">Last Name</label>
      <input type="text" class="form-control" id="lname" name="lname" value="<?= $user['lname'] ?>" placeholder="Example input placeholder">
    </div>
    <div class="col-12">
    ...
    <div class="col-12">
      ...
      <input type="text" class="form-control" id="username" name="username" value="<?= $user['username'] ?>" placeholder="Example input placeholder">
    </div>
