...
<main id="content">
    ...
    <div class="row row-cols-1 row-cols-lg-2 row-cols-xl-2 row-cols-xxl-4 g-5 mb-5">
        <div class="col d-flex flex-column">
            <div id="btnGroup1" class="btn w-100 p-3">
                ...
                <img src="<?= base_url() ?>/students.png" class="float-end dash-bg" alt="">
            </div>
        ...
        <div class="col d-flex flex-column">
            <div id="btnGroup2" class="btn w-100 p-3">
                ...
                <img src="<?= base_url() ?>/books.png" class="float-end dash-bg" alt="">
            </div>
        ...
        <div class="col d-flex flex-column">
            <div id="btnGroup3" class="btn w-100 p-3">
                ...
                <img src="<?= base_url() ?>/borrowed.png" class="float-end dash-bg" alt="">
            </div>
        ...
        <div class="col d-flex flex-column">
            <div id="btnGroup4" class="btn w-100 p-3">
                ...
                <img src="<?= base_url() ?>/return.png" class="float-end dash-bg" alt="">
            </div>
