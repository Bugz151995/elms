  ...
  <div class="container-fluid">
    ...
    <div class="dropdown dropstart">
      <a href="#" class="d-flex align-items-center text-decoration-none text-dark" id="dropdownAdminBtn" data-bs-toggle="dropdown" aria-expanded="false">
        <img src="<?= base_url() ?>/default.png" alt="" width="32" height="32" class="rounded-circle border-3 border user-border me-2 p-1">
      </a>
      <ul id="dropdownAdmin" class="dropdown-menu text-small shadow p-3" aria-labelledby="dropdownAdminBtn">
        <li>
          <a class="dropdown-item d-flex align-items-center" href="#">
            <img src="<?= base_url() ?>/default.png" alt="" width="50" class="rounded-circle border-3 border border-primary me-2 p-1">
            <p class="ps-2 m-0">
